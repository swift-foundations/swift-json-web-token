...
//
// Copyright (c) 2026 Coen ten Thije Boonkkamp and the swift-json-web-token project authors
...
// it only while swift-json-web-token and swift-institute-linter-rules are both
...
Lint.run(dependencies: [
    ...
    // to switch:
    // .package(
    //     path: "{{RELPATH_INSTITUTE_RULES}}",
    //     products: ["Linter Institute Rules"]
    // ),
]) {
    Lint.Rule.Bundle.institute
    // If swift-json-web-token owns a brand vocabulary, narrow with
